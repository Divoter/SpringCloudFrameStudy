package com.divoter.orderserver.generator1;
...
public class CodeGenerator {
    ...
    //项目名称
    private static final String PROJECT_NAME="/order-server";
    ...
    private static boolean useRestFul = true;

    public static void main(String[] args) {
        useRestFul = true;
        genCode("order_detail","order_master");
    }
